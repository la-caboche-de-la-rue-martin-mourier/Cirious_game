...
function plainte(){
    ...
    Button1.animations.add('hoover',[0,1],20,false);
    Button1.animations.add('notHoover',[1,0,2],20,false);
    Button1.animations.add('click',[2],20,false);
    Button1.inputEnabled = true;
    Button1.smoothed = false;
    Button1.events.onInputDown.add(mychoice, this);
    Button1.events.onInputOver.add(Button1.animations.play("hoover"), this);
    
    Button1.animations.play("click");*/
    button1 = game.add.button(100, 460, 'choice', mychoice, this, 1, 0 ,2);
}
