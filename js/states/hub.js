var hubState = {
	...
	create : function(){
        ...
        // Access ramps
        rampe1 = game.add.sprite(448,573,'rampe');
        rampe2 = game.add.sprite(192,573,'rampe');
        rampe3 = game.add.sprite(543,670,'rampe');
        rampe1.alpha = 0;
        rampe2.alpha = 0;
        rampe3.alpha = 0;
        ...
        visu = this.playerB.animations.add('visu',[20,21,22,23,24,25,26,27],10,false);
        ...
        //When the radar animation is done, we put back back its invisible state
        ...
        //Timer for the delay of the crossroads fire
        fireTimer = 0;
	...
	update : function(){
		...
		//Let the car pass in function of the Fire state
        ...
        game.physics.arcade.collide(this.leftcarz , this.playerA, perdu, null , this);
        game.physics.arcade.collide(this.rightcarz , this.playerA, perdu, null , this);
        game.physics.arcade.collide(this.backcarz , this.playerA, perdu, null , this);
        game.physics.arcade.collide(this.frontcarz , this.playerA, perdu, null , this);

        game.physics.arcade.collide(this.leftcarz , this.playerB , perdu ,null , this);
        game.physics.arcade.collide(this.rightcarz , this.playerB , perdu , null, this);
        game.physics.arcade.collide(this.backcarz , this.playerB , perdu , null , this);
        game.physics.arcade.collide(this.frontcarz , this.playerB , perdu , null , this);
        ...
        //PLayer A controls (Wheelchair guy)
        ...
        //PLayer B controls (Blind person)
        if (keyQ.isDown)
        {
